...
export function commuteScore(minutes) {
  ...
  if (minutes <= 30) return 1 - ((minutes - 20) / 10) * 0.10;
  if (minutes <= 45) return 0.90 - ((minutes - 30) / 15) * 0.30;
  if (minutes <= 60) return 0.60 - ((minutes - 45) / 15) * 0.30;
  if (minutes <= 90) return 0.30 - ((minutes - 60) / 30) * 0.30;
  return 0;
}
