...
export const CANDIDATE_REGIONS = [
  ...
  {
    id: 'jung_sindang', gu: '중구', dong: '신당동',
    lawdCd: '11140',
    coords: { lat: 37.5617, lng: 127.0165 }, pin: { x: 55, y: 34 },
    options: [{ type: '전세', depositMan: 16000 }, { type: '월세', depositForRent: 800, rentMan: 58 }],
    maintenanceFee: 5, avgJeonsaMan: 16000, avgRentMan: 58,
    defaultLife: { subway: 2, store: 8, mart: 1, hospital: 5 },
  },
];
